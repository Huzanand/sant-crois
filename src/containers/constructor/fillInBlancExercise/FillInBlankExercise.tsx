...
const FillInBlancExercise = ({ onUpdate, initialContent }: { onUpdate?: (json: any) => void, initialContent?: any }) => {
    ...
    return (
        <div className={styles.container}>
            <div className={styles.info}>
                ...
                <p className={`body-m ${styles.description} ${styles.addMargin}`}>
                    You can highlight words that need clarification. Idioms, phrases, slang, etc.
                </p>
            </div>
...
export default FillInBlancExercise