...
import styles from "./previewChooseTeplateTask.module.css";
...
import { MultipleChoice } from "@/components/common/editor/extensions/MultipleChoice";
...
const PreviewChooseTeplateTask: React.FC<propsTypes> = ({ taskData, index, readonly }) => {
...
export default PreviewChooseTeplateTask;
