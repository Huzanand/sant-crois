...
const CreateVRForm = () => {
  ...
  const { lesson, fetchLessonById } = useOwnStore((state) => state);
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.container}>
        {stage === "stage1" && (
          <>
            <div className={style.header}>
              <h1 className="headlines-m">Создание виртуальной комнаты</h1>
              <h2 className="headlines-s">
                Для создания комнаты заполните поля ниже.
              </h2>
              <h2 className="headlines-s">
                После того, как комната будет создана, вы получите ссылку для
                прохождения урока вашим учеником.
              </h2>
            </div>
            ...
            >
              <div className={style.form_item}>
                <p className={`body-m ${style.form_descr}`}>
                  Для получения результатов введите адрес вашей электронной
                  почты
                </p>
              ...
              <div className={style.form_item}>
                <p className={`body-m ${style.form_descr}`}>
                  Напишите имя ученика. Это поможет вам понять чей результат вы
                  получили
                </p>
              ...
              <div>
                <button className={style.btn} type="submit">
                  {loading ? "Creating a room..." : "Create VR room"}
                </button>
        ...
        {stage === "stage2" && (
          <>
            <h1 className="headlines-m">Комната успешно создана!</h1>
            <h2 className="headlines-s">Теперь вы можете поделиться уроком</h2>
            <p className="body-m">Скопируйте ссылку и отправте ученику</p>
            ...
            <div>
              <div className={style.input_container}>
                ...
                />
                <button onClick={handleCopy} className={style.input_copyBtn}>
            ...
            <button onClick={() => setStage("stage3")} className={style.btn}>
              Ready
            </button>
          </>
        )}
        ...
        {stage === "stage3" && (
          <>
            ...
            <p className="body-l">
              Вы получите результаты на указанную почту,когда студент закончит
              выполнение урока
            </p>
